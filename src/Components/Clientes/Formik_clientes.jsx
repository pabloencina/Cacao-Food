...
import calificar_image from '../../Images/clientes-images/calificar.png'

const FormikSectionClientes = () => {
    ...
    return (
        ...
        >
            <Form>
                ...
                <div className="contactanos__text_input_box">
                    <p className="contactanos__text_input">
                        Califica nuestro servicio: <span className="contactanos__asterisco">*</span>
                    </p>
                    <img className="clientes__img--calificar" alt='calificar' src={calificar_image} />
                </div>
                <div>
                    <div className="contactanos__text_input_box">
                        <p className="contactanos__text_input">
...
export default FormikSectionClientes;