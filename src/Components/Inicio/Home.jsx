    ...
    return (
        <Container fluid>
            <Row className="justify-content-center home">
                <Col xs={12} md={6} className='home__presentacion'>
                ...
                <Col xs={12} md={6} className='home__presentacion--img'>
            ...
            <Row className="justify-content-center home">
                ...
                <p className='home__nosotros--texto'>Conocé sobre nosotros, nuestra historia y proyectos futuros</p>
                <Image src="/multimedia/imagen_prueba.jpg" rounded fluid />
            </Row>
        </Container>
    );
